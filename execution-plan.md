...
| P1 | Add GraphQL composition surface to the Go BFF | BFF + frontend | Stable domain gRPC contracts; schema and resolver tests | Schema contract added; resolver endpoint next |
