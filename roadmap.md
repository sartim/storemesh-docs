...
| Production platform hardening | In progress | Domain Helm charts include one-replica PodDisruptionBudgets and gRPC ingress NetworkPolicies ([PR #9](https://github.com/sartim/storemesh-helm-repo/pull/9)), opt-in ExternalSecret resources for all four service charts ([PR #10](https://github.com/sartim/storemesh-helm-repo/pull/10)), and an opt-in User Service HTTPS Ingress ([PR #11](https://github.com/sartim/storemesh-helm-repo/pull/11)); certificate-manager deployment, dashboards, alerts, and backup/recovery evidence remain next |
