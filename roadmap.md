...
| Additional domain services | In progress | Product catalog contract, PostgreSQL persistence, JWT authorization, and deployment definitions are available in [`storemesh-product-service`](https://github.com/sartim/storemesh-product-service); local Argo CD deployment is healthy |
