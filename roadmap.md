...
| Additional domain services | In progress | Product Service is deployed and healthy; Inventory Service contract and reservation runtime are available in [`storemesh-inventory-service`](https://github.com/sartim/storemesh-inventory-service) |
