...
| Additional domain services | In progress | Product catalog contract and initial in-memory gRPC runtime are available in [`storemesh-product-service`](https://github.com/sartim/storemesh-product-service); PostgreSQL persistence is next |
