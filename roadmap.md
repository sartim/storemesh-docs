...
| Additional domain services | In progress | Product Service is deployed and healthy; Inventory Service stock and reservation boundary is established in [`storemesh-inventory-service`](https://github.com/sartim/storemesh-inventory-service) |
