...
| Feature management | Planned | Use GitHub Actions and Helm for versioned infrastructure/deployment flags; introduce OpenFeature behind a self-hosted Flagsmith provider for runtime BFF, Next.js, Android, and iOS product flags. Keycloak remains the identity and authorization authority. |
