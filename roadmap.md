...
| Web frontend | In progress | Next.js, React, and TypeScript frontend provides Keycloak login, catalog loading, account-scoped persistent-cart loading/clear/add, order creation, order history, and a role-aware admin area through the BFF. Rich cart editing and checkout confirmation remain next. |
