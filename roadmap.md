...
| Additional domain services | In progress | Product catalog contract, in-memory mode, and PostgreSQL persistence are available in [`storemesh-product-service`](https://github.com/sartim/storemesh-product-service); authentication and deployment are next |
