...
| Additional domain services | In progress | Product Service is deployed and healthy; Inventory Service contract, reservation runtime, PostgreSQL schema, and transactional repository are available in [`storemesh-inventory-service`](https://github.com/sartim/storemesh-inventory-service) |
