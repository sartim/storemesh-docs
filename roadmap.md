...
| Additional domain services | In progress | Product and Inventory Services are deployed and healthy; Order Service lifecycle boundary is established in [`storemesh-order-service`](https://github.com/sartim/storemesh-order-service) |
