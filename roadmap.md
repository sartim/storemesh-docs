...
| Additional domain services | In progress | Product Service is deployed and healthy; Inventory Service contract, reservation runtime, and PostgreSQL schema foundation are available in [`storemesh-inventory-service`](https://github.com/sartim/storemesh-inventory-service) |
