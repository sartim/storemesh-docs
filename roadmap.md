...
| Additional domain services | In progress | Product and Inventory Services are deployed and healthy; Order Service contract and initial lifecycle runtime are available in [`storemesh-order-service`](https://github.com/sartim/storemesh-order-service) |
