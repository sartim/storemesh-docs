...
export default function Home() {
  return <main className="shell">
    ...
    <section className="section-heading"><p className="eyebrow">Documentation</p><h2>Choose a path through the platform</h2><p>Use the architecture and repository map to understand the system, then use operations and observability when you are ready to run it.</p></section>
